Maybe trees based on [subtotals](Example-05-01-Tree-en.md) are more common, but in sap there are some other hierarchical data like WBS elements or HR organizational units.<br/>
