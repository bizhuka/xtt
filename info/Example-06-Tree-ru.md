Возможно, деревья основанные на [подитогах](Example-05-01-Tree-ru.md) более распространены, но в SAP есть некоторые другие иерархические данные, такие как СПП-элементы или организационные единицы HR.<br/>
