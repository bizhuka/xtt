CLASS zcl_xtt_demo_020 DEFINITION PUBLIC INHERITING FROM zcl_xtt_demo CREATE PUBLIC.
  PUBLIC SECTION.
    METHODS:
      constructor,
...
CLASS zcl_xtt_demo_020 IMPLEMENTATION.

  METHOD constructor.
    super->constructor( ).
    v_desc = 'Basic table example'(020).
  ENDMETHOD.
  ...
  METHOD set_merge_info.
    ...
    " {R-T} in a template. @see get_random_table description
    mo_report->get_random_table( IMPORTING et_table = ls_root-t ).
