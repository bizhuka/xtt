CLASS zcl_xtt_demo_021 DEFINITION PUBLIC INHERITING FROM zcl_xtt_demo_020 CREATE PUBLIC .
...
CLASS zcl_xtt_demo_021 IMPLEMENTATION.
  ...
  METHOD set_merge_info.
    ...
    mo_report->merge_add_one( is_root    = lt_add
                              iv_root_id = 'A' ).
  ENDMETHOD.
