class ZCX_XTT_EXCEPTION definition
  public
...
*"* public components of class ZCX_XTT_EXCEPTION
*"* do not include other source files here!!!
  interfaces IF_T100_MESSAGE .

  constants:
    begin of ZCX_XTT_EXCEPTION,
      msgid type symsgid value 'ZSY_XTT',
      msgno type symsgno value '000',
      attr1 type scx_attrname value 'MSGV1',
      attr2 type scx_attrname value 'MSGV2',
      attr3 type scx_attrname value 'MSGV3',
      attr4 type scx_attrname value 'MSGV4',
    end of ZCX_XTT_EXCEPTION .
...
protected section.
*"* protected components of class ZCX_XTT_EXCEPTION
*"* do not include other source files here!!!
private section.
*"* private components of class ZCX_XTT_EXCEPTION
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCX_XTT_EXCEPTION IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_XTT_EXCEPTION .
else.
...
METHOD raise_sys_error.
  ...
  " Devided to blocks
  RAISE EXCEPTION TYPE zcx_xtt_exception
    EXPORTING
      textid = zcx_xtt_exception=>zcx_xtt_exception
